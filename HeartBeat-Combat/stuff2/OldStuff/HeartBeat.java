...
// public HeartBeat(Player player, Enemy enemy, InputDriver inputDriver, int
// baseDistance) {
...
// if (pState == Player.PlayerState.NOT_IN_COVER && eState ==
// Enemy.EnemyState.LOOKING) {
...
// // combatDistance = ((int) Math.pow(player.perception, 2) / 2) +
// baseDistance;
...
// System.out.println("DMG after DMG Reduction: " + (dmgDealt *
// enemy.armour.percentDmgReduction));
// enemy.hp -= (dmgDealt * enemy.armour.percentDmgReduction);

// System.out.printf("\n[You hit the enemy for %f]", (dmgDealt *
// enemy.armour.percentDmgReduction));
...
// System.out.println("\n*The enemy sprays towards your cover and their bullets
// miss you...*");
...
// }
// } else {
// System.out.println("*\nA hail of bullets whizz pass you but miss you
// entirely...*");
// }
